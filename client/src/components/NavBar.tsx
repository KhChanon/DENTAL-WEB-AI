  ...
  return (
    <div className="bg-darkslateblue-200 flex flex-row items-center justify-between w-screen h-12 py-2 select-none">
      <div className='flex flex-row h-12 items-center gap-3'>
        ...
        />
        <div 
          className='text-3xl font-semibold text-white cursor-pointer align-middle iphone:text-xl'
          onClick={() => {window.location.href = '/faq'}}
        >FAQ</div>
      </div>
      <div className='flex flex-row bg-darkslateblue-200 items-center justify-between h-fit mr-7 text-white border-0 text-2xl font-bold cursor-pointer select-none iphone:text-xl'
