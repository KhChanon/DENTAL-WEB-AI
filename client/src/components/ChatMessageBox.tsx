...
const ChatMessageBox: React.FC<ChatMessegeProp> = ({userchat,chattime,chattext}) => {
  ...
  return (
    <div className={`flex items-center justify-center mx-3 py-2 px-3 w-fit h-fit bg-[#1d435f] rounded-3xl text-white font-medium text-base text-left ${self_align} max-w-[45%] text-wrap`}>
