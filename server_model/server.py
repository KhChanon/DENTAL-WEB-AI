...
contexts = {
    ...
    "ผ่าฟันคุด" : {
        ...
        "Symptom Related": "การถอนฟันคุดมีอันตรายหรือความเสี่ยงจากการผ่าฟันคุดนั้นอยู่ในระดับต่ำ ความเสี่ยงที่น่าจะเกิดถ้าไม่ถอนฟันคุดเช่นอาการปวดเรื้อรังหรือรู้สึกไม่สบาย เนื่องจากแรงดันของฟันคุด ฟันยื่น ฟันเก กระดูกรอบรากฟัน หรือรากฟันข้างเคียงถูกทำลาย จะรู้ได้อย่างไรว่าแผลติดฟันคุดเชื้อเช่นเกิดหนองออกมาบริเวณแผล ถ้าฟันคุดใกล้เส้นประสาทอันตรายมากไม่อันตราย ปัจจัยเสี่ยงใดที่ทำให้ฟันคุดเกิดอาการอักเสบคือเชื้อแบคทีเรียที่มาสะสมอยู่ ปัจจัยเสี่ยงที่ทำให้ฟันคุดต้องถอนเช่นเหงือกในบริเวณที่ปกคลุมฟันคุดอักเสบหรือมีการติดเชื้อหรือเกิดฟันผุที่ฟันกรามซี่ข้างเคียง หากหลังได้รับการผ่าฟันคุดเป็นเวลา 2 ชั่วโมงแล้วสังเกตุได้ว่าเลือดไหลไม่หยุดถือว่าไหลมาก หากมีอาการชาบริเวณที่ผ่าหลังผ่าฟันคุดควรทานวิตามิน B1-6-12 ช่วยบำรุงเส้นประสาท หลังผ่าฟันคุดมีหนองต้องไปพบทันตแพทย์ทันที"
    },
    "ผ่าตัดเหงือก" : {
